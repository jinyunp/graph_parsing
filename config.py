...
# HF Transformers — 기본값을 Qwen2.5-VL-3B-Instruct로 변경
HF_MODEL_ID = os.environ.get("HF_MODEL_ID", "Qwen/Qwen2.5-VL-3B-Instruct")
...
OLLAMA_MODEL = os.environ.get("OLLAMA_MODEL", "qwen2.5vl:3b")  # 사용자 지정명 반영
